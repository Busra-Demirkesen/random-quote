...
function QuoteCard() {
  ...
  return (
    <div className="border border-gray-300 p-5 rounded-lg bg-[#a89882] shadow-lg">
      <p className="text-lg italic mb-2 text-white">"{quoteObj.quote}"</p>
      <p className="font-bold mb-2 text-white">- {quoteObj.author}</p>
      <p className="text-base text-white"><i className="fa-solid fa-heart"></i> {quoteObj.likeCount}</p>
    </div>
  );
}
